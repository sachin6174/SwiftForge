...
public struct Question: Identifiable, Codable, Hashable {
    ...
    public init(id: String, title: String, category: String, difficulty: String, topics: [String], description: String, templateCode: String, solutionCode: String, testHarness: String, networkUrl: String? = nil) {
        self.id = id
        self.title = title
